...
export default function Home() {
  return (
    ...
    <AboutSection />
    <section id="doctor" className="relative isolate overflow-hidden bg-tree-blue text-white py-16">
  <HexGridOverlayFilled
              ...
              />
  <div aria-hidden className="pointer-events-none absolute inset-x-0 -top-20 h-0">
